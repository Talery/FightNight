...
export const synergyDescriptions: Record<SynergyTag, string> = {
  blood: 'Клинки, кровотечение и эффекты, которые усиливают раненые цели.',
  poison: 'Яды, кинжалы и постепенное истощение противника.',
  heavy: 'Сила, булавы и тяжёлые удары, ломающие защиту.',
  counter: 'Копья, точные блоки и ответные удары после защиты.',
  evasion: 'Ловкость, финты и уклонение от опасных атак.',
  relics: 'Мистические предметы, бомбы и необычные эффекты.',
  survival: 'Броня, запас здоровья и восстановление между угрозами.',
  trade: 'Удача, золото и более выгодная работа с добычей.',
}
